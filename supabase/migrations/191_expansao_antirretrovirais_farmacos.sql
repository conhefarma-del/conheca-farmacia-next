...
JOIN (VALUES
  ...
  ('darunavir',
   ...
   'Darunavir is a second-generation protease inhibitor with a high genetic barrier to resistance, boosted by ritonavir or cobicistat.',
  ...
  ('raltegravir',
   'O raltegravir é um inibidor da integrase utilizado no tratamento do HIV, com metabolismo dependente de UGT1A1.',
   'Raltegravir is an integrase inhibitor used in HIV treatment, with UGT1A1-dependent metabolism.',
   'Bloqueia a enzima integrase do HIV-1 ao ligar-se ao sítio ativo, impedindo a transferência de filamento de DNA e, consequentemente, a integração do DNA viral no genoma da célula hospedeira.',
  ...
  ('etravirina',
   ...
   'Etravirine is a second-generation NNRTI effective against HIV strains resistant to first-generation NNRTIs.',
  ...
  ('rilpivirina',
   ...
   'Rilpivirine is a next-generation NNRTI with good tolerability and lower rates of neuropsychiatric effects compared to efavirenz.',
