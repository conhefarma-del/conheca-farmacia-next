...
Tens acesso a todas as ferramentas do Conheça Farmácia.
</p>
</td></tr>

<tr><td style="padding:32px 40px">
<table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f0f7f4;border-radius:8px;overflow:hidden">
<tr><td style="padding:24px">
<p style="margin:0 0 4px 0;font-size:11px;color:#0a844f;text-transform:uppercase;letter-spacing:2px;font-weight:600;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">A tua conta</p>
<p style="margin:0 0 12px 0;font-size:16px;color:#1a1a1a;font-weight:600;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">Progresso guardado em qualquer dispositivo</p>
<p style="margin:0;font-size:13px;color:#555555;line-height:1.6;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">O teu progresso nas competições, quiz e flashcards fica guardado na tua conta. Podes aceder de qualquer dispositivo, a qualquer momento.</p>
</td></tr>
</table>
</td></tr>

<tr><td style="padding:0 40px 32px 40px">
<p style="margin:0 0 24px 0;font-size:11px;color:#0a844f;text-transform:uppercase;letter-spacing:2.5px;font-weight:600;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">As tuas ferramentas</p>
<table width="100%" cellpadding="0" cellspacing="0">
<tr><td style="padding:0 0 20px 0"><table width="100%" cellpadding="0" cellspacing="0"><tr><td width="40" valign="top" style="padding-top:2px"><div style="width:32px;height:32px;background-color:#e8f5f0;border-radius:50%;text-align:center;line-height:32px"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00493a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg></div></td><td valign="top" style="padding-left:12px"><p style="margin:0 0 4px 0;font-size:14px;color:#1a1a1a;font-weight:600;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">Calculadora de Interações</p><p style="margin:0;font-size:13px;color:#888888;line-height:1.5;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">Verifica interações medicamentosas entre dois fármacos em segundos</p></td></tr></table></td></tr>
<tr><td style="padding:0 0 20px 0"><table width="100%" cellpadding="0" cellspacing="0"><tr><td width="40" valign="top" style="padding-top:2px"><div style="width:32px;height:32px;background-color:#e8f5f0;border-radius:50%;text-align:center;line-height:32px"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00493a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><path d="m10.5 20.5 10-10a4.95 4.95 0 1 0-7-7l-10 10a4.95 4.95 0 1 0 7 7Z"/><path d="m8.5 8.5 7 7"/></svg></div></td><td valign="top" style="padding-left:12px"><p style="margin:0 0 4px 0;font-size:14px;color:#1a1a1a;font-weight:600;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">Medicamentos</p><p style="margin:0;font-size:13px;color:#888888;line-height:1.5;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">Fichas completas com mecanismos, interações e fontes DailyMed/EMC</p></td></tr></table></td></tr>
<tr><td style="padding:0 0 20px 0"><table width="100%" cellpadding="0" cellspacing="0"><tr><td width="40" valign="top" style="padding-top:2px"><div style="width:32px;height:32px;background-color:#e8f5f0;border-radius:50%;text-align:center;line-height:32px"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00493a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/></svg></div></td><td valign="top" style="padding-left:12px"><p style="margin:0 0 4px 0;font-size:14px;color:#1a1a1a;font-weight:600;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">Quiz Competição</p><p style="margin:0;font-size:13px;color:#888888;line-height:1.5;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">Representa a tua escola em competições ao vivo com leaderboard</p></td></tr></table></td></tr>
...
<tr><td align="center" style="padding-top:12px"><a href="https://conhecafarmacia.com/pt/competicao" style="display:inline-block;color:#0a844f;text-decoration:none;font-size:13px;font-weight:600;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif">ou entra numa Competição &rarr;</a></td></tr>
</table>
</td></tr>
