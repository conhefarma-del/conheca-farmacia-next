...
class ErrorHandler {
    ...
    logToDebug(message, severity) {
        if (!this._debugContainer) {
            this._debugContainer = document.getElementById('log') || document.getElementById('debug-log');
        }
    ...
    _ensureToastContainer() {
        if (!this._toastContainer) {
            ...
            this._toastContainer.className = 'fixed top-5 right-5 z-[100] flex flex-col gap-2 pointer-events-none';
