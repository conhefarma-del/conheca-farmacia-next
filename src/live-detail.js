...
function renderLiveDetail(live) {
	...
	document.getElementById('live-platform-meta').style.backgroundColor = categoryColor + '20';
	...
	document.getElementById('live-time-meta').textContent = `${live.hora} — ${formatTimeDuration(live.hora, getEndTime(live))}`;
	...
	const meetingPasswordContainer = document.getElementById('meeting-password-container');
	...
	document.getElementById('host-organization').textContent = live.anfitriao.organizacao;
