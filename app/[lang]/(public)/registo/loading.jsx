    ...
    <section className="py-20 bg-background">
      <div className="container-center max-w-md mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <div className="h-9 w-32 mx-auto rounded-lg mb-3" style={pulse} />
          <div className="h-5 w-64 mx-auto rounded" style={{ ...pulse, opacity: 0.6 }} />
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="h-4 w-32 rounded mb-2" style={{ ...pulse, opacity: 0.6 }} />
            <div className="h-12 w-full rounded-xl" style={pulse} />
          </div>
        ...
        <div className="mt-6 text-center">
          <div className="h-4 w-36 mx-auto rounded" style={{ ...pulse, opacity: 0.4 }} />
        </div>
      </div>
    </section>
  )
