...
export async function searchAllContent(query, lang = 'pt', type = 'todos', order = 'recente') {
  ...
  const [articlesRes, eventsRes, guidesRes, protocolosRes, sciRes, authRes, interviewsRes, peopleRes, flashDecksRes, drugsRes, drugLookupRes, ffRes, foodRes, diseaseRes, pregRes] = await Promise.all(queries)
