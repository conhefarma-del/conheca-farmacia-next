...
const EVENT_COLUMNS = 'id, slug, title, excerpt, image_url, category, category_label, date, time, end_time, location, location_maps_url, location_maps_embed_url, type, capacity, hosts, status, featured_langs, registration_link, platform, access_link, meeting_id, password, materials, topic, registration_enabled'
