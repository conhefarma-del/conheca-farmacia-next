...
const SCIENTIFIC_ARTICLE_COLUMNS =
  'id, slug, title, abstract, keywords, category_id, doi, authors, content, references_arr, read_time, status, featured, published_at, created_at, is_archived, view_count, scientific_categories(slug, name_pt, name_en, color)'
