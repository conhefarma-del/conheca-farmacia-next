...
// rule into Node Buffers, which is the shape satori.loadFont expects.
...
async function registerFonts() {
  ...
  await satori.loadFont({ name: 'sans-serif', data: buf(notoSansRegular), weight: 400, style: 'normal' })
  await satori.loadFont({ name: 'sans-serif', data: buf(notoSansMedium), weight: 500, style: 'normal' })
  await satori.loadFont({ name: 'sans-serif', data: buf(notoSansSemiBold), weight: 600, style: 'normal' })
  await satori.loadFont({ name: 'sans-serif', data: buf(notoSansBold), weight: 700, style: 'normal' })
  await satori.loadFont({ name: 'serif', data: buf(notoSerifRegular), weight: 400, style: 'normal' })
  await satori.loadFont({ name: 'serif', data: buf(notoSerifSemiBold), weight: 600, style: 'normal' })
  await satori.loadFont({ name: 'serif', data: buf(notoSerifBold), weight: 700, style: 'normal' })
  await satori.loadFont({ name: 'monospace', data: buf(notoMonoRegular), weight: 400, style: 'normal' })
  await satori.loadFont({ name: 'monospace', data: buf(notoMonoBold), weight: 700, style: 'normal' })
