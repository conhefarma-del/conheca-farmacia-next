...
export async function proxy(request) {
  ...
  const csp = [
    ...
    `media-src 'self' blob: https://*.supabase.co https://*.spotify.com https://*.scdn.co https://*.spotifycdn.com`,
    `font-src 'self' https://fonts.gstatic.com`,
    `connect-src 'self' https://*.supabase.co https://vercel.live https://www.youtube.com https://s.ytimg.com https://open.spotify.com https://*.spotifycdn.com`,
    `frame-src https://www.google.com https://maps.google.com https://www.youtube.com https://www.youtube-nocookie.com https://open.spotify.com`,
